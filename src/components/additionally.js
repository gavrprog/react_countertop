    ...
    return (
        <>
            ...
            <div  className="additionally">
                <div>
                    <input id="add-sink" type="checkbox" {...register('additional.sink')}/>
                    <label htmlFor="add-sink">Монтаж мойки под столешницу</label>
                </div>		
                <div>
                    <input id="add-montage" type="checkbox" {...register('additional.montage')}/>
                    <label htmlFor="add-montage">Монтаж</label>
                </div>
                <div>
                    <input id="add-delivery" type="checkbox" {...register('additional.delivery')}/>
